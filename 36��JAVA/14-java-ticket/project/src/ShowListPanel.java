...
class ShowListPanel extends JPanel
{
	private static final Timer time = new Timer("SHOWRUNNER");
	...
	{
		String[] names = {"ID", "Movie Name", "Cinema ID", "Show Date", "Show Time"};		

		for (int i = 0; i < names.length; i++)
			colNames.add(names[i]);

		String sql = MySqlHash.getHashSql("SHOW LIST");
