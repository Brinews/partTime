...
* Ret: PeopleInfo_p *p
*/
PeopleInfo_p DataSort::ps_readin(char *filename)
{
...
void DataSort::ps_print(PeopleInfo_t p, ostream& out)
{
 ...
 * Ret: null
 */
void DataSort::ps_writeout(PeopleInfo_t *arr, int siz, char *filename)
{
 ...
 * Ret: PeopleInfo_t a
 */
PeopleInfo_p DataSort::ps_namesearch(PeopleInfo_t *arr, int siz, char *name)
{
 ...
 * Ret: null
 */
void DataSort::ps_testsearch(PeopleInfo_t *arr, int siz)
{
	char buf[NAMLEN];
 ...
 */
int DataSort::ps_findmax(PeopleInfo_t *arr, int s, int e)
{
 ...
 * Ret : null
 */
void DataSort::ps_swap(PeopleInfo_t *arr, int left, int right)
{
	PeopleInfo_t tmp;
 ...
 * Ret: arr
 */
PeopleInfo_p DataSort::ps_dosort(PeopleInfo_t *arr, int siz)
{
	int max = 0;
 ...
 * Ret: milliseconds
 */
double DataSort::ps_timecost(PeopleInfo_t *arr, int siz)
{
 ...
 * Ret : null
 */
void DataSort::ps_doclear(PeopleInfo_t *arr)
{
	delete []arr;
	arr = NULL;
}
...
int main(int argc, char **argv)
{
	...
	while (cin >> fname)
	{
		...
		ds.ps_timecost(arr, ds.getsize());

		strcpy(pname, "sort_");
		strcat(pname, fname);
		// write out sorted list
		cout << "Begin Write the sorted result into File : " << pname << endl;
		ds.ps_writeout(arr, ds.getsize(), pname);
