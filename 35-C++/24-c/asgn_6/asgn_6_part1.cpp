...
* Return@(r)
*/
unsigned int DiffSort::ps_random_in_range(int x, int y)
{
	int rd = rand()%(y-x+1);
 ...
 * Ret: PeopleInfo_p *p
 */
PeopleInfo_p DiffSort::ps_readin(char *filename)
{
	char outfile[NAMLEN];
...
void DiffSort::ps_print(PeopleInfo_p p, ostream& out)
{
	char telstr[TELSTR];
 ...
 * Ret: null
 */
void DiffSort::ps_writeout(PeopleInfo_t *arr, int siz, char *filename)
{
 ...
 * Ret: PeopleInfo_t a
 */
PeopleInfo_p DiffSort::ps_namesearch(PeopleInfo_t *arr, int siz, char *name)
{
 ...
 * Param@(int[3], char *)
 */
void DiffSort::ps_telno2string(unsigned int *telno, char *str)
{
 ...
 * Return: PeopleInfo_t
 */
PeopleInfo_p DiffSort::ps_telsearch(PeopleInfo_t *arr, int siz, char *telno)
{
	PeopleInfo_t *ret = NULL;
	char telstr[TELSTR];
 ...
 * Ret: null
 */
void DiffSort::ps_testsearch(PeopleInfo_t *arr, int siz)
{
	char buf[NAMLEN];
 ...
 */
int DiffSort::ps_findmax(PeopleInfo_t *arr, int s, int e)
{
 ...
 */
int DiffSort::ps_nameorder(PeopleInfo_t *arr, int s, int e)
{
 ...
 * Ret : null
 */
void DiffSort::ps_swap(PeopleInfo_t *arr, int left, int right)
{
	PeopleInfo_t tmp;
 ...
 * Ret: arr
 */
PeopleInfo_p DiffSort::ps_dosort(PeopleInfo_t *arr, int siz)
{
	int max = 0;
 ...
 * selection sort
 */
void DiffSort::ps_selectionsort(PeopleInfo_t *arr, int siz)
{
	int max = 0;
...
int DiffSort::ps_cmpbyname(PeopleInfo_t *p, PeopleInfo_t *q)
{
	int l, r;
 ...
 * insertion sort
 */
void DiffSort::ps_insertionsort(PeopleInfo_t *arr, int siz)
{
	int i, j;
 ...
 */
void DiffSort::ps_impinsertsort(PeopleInfo_t *arr, int siz)
{
	int i, j;
	PeopleInfo_t tmp;
 ...
 * Bubble sort 
 */
void DiffSort::ps_bubblesort(PeopleInfo_t *arr, int siz)
{
	int i, j;
 ...
 */
void DiffSort::ps_twosidebubblesort(PeopleInfo_t *arr, int siz)
{
 ...
 * Ret: milliseconds
 */
double DiffSort::ps_timecost(PeopleInfo_t *arr, int siz, char *fname)
{
	double start, end;
	char pname[NAMLEN];
 ...
 * Ret : null
 */
void DiffSort::ps_doclear(PeopleInfo_t *arr)
{
	delete []arr;
	arr = NULL;
}
...
int main(int argc, char **argv)
{
	...
	while (cin >> fname)
	{
		...
		PeopleInfo_t *arr = ds.ps_readin(fname);

		//do test research function
		ds.ps_testsearch(arr, ds.getsize());

		//calculate the sort cost time
		ds.ps_timecost(arr, ds.getsize(), fname);
